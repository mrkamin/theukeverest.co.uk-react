      ...
      <div className="cart-items d-flex flex-column text-center p-3 gap-3 w-75">
        <div className="cart-item align-items-center justify-content-center text-center">
          ...
          <div className="text-start ">
            ...
            <p className="p-0 m-0">
              We offer{" "}
              <span>professional turnkey air conditioning solutions</span> for
              industrial and commercial premises of any size, working as
              contractors to the construction industry or directly to the end
              user client.
            </p>
          </div>
        </div>
      ...
      <div className="cart-items d-flex flex-column text-center p-3 gap-3 w-75">
        <div className="cart-item align-items-center justify-content-center text-center">
          ...
          <div className="text-start ">
            ...
            <p className="p-0 m-0">
              We offer a range of complete climate controlled solutions for your
              home using the latest high spec systems and advanced technologies.
            </p>
          </div>
        </div>
        <Link to="air-conditioning" className="read-more p-2 rounded-5">
      ...
      <div className="cart-items d-flex flex-column text-center p-3 gap-3 w-75">
        <div className="air-cart-item align-items-center justify-content-center text-start">
          ...
          <div className="text-start ">
            ...
            <p className="p-0 m-0">
              We offer specialist{" "}
              <span>air conditioning maintenance and service packages </span>for
              all types of commercial and domestic air conditioning systems.
            </p>
          </div>
        </div>
        <Link to="air-conditioning" className="read-more p-2 rounded-5">
      ...
      <div className="cart-items d-flex flex-column text-center p-3 gap-3 w-75">
        <div className="air-cart-item align-items-center justify-content-center text-center">
          ...
          <div className="text-start ">
            ...
            <p className="p-0 m-0">
              Our on-site <span>Call Out</span> inspection is <span>FREE</span>{" "}
              and our trained engineers are usually able to complete repairs on
              the first visit to get your system back up and running quickly.
            </p>
          </div>
        </div>
        <Link to="air-conditioning" className="read-more p-2 rounded-5">
        ...
        <div className="air-cart-item align-items-center justify-content-center text-center">
          ...
          <div className="text-start ">
            ...
            <p className="p-0 m-0">
              ...
              Using our years of experience , Be Cool has selected the very best
              wall mounted and floor mounted air conditioning units on the
              market, the Mitsubishi SRK-ZSP-S and SRF-ZMX-S. Renowned for high
              quality and reliability, Mitsubishi uses the latest technology to
              offer a robust unit with remote controlled, variable temperature
              settings which can be programmed and scheduled to switch on and
              off to suit you.
            </p>
          </div>
        </div>
