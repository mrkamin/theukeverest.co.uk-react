  ...
  return (
    <div className="home position-relative">
      ...
      <div className="cart-container gap-3 w-100 p-3">
        ...
        <img src={AIRCONDITIONIMG} alt="air" height={50} className="cart-icon"/>
        <div className="text-start">
          <h3 className="p-0 m-0">Air Conditioning Europe</h3>
          <p className="p-0 m-0">Specialist Design and Installation</p>
        </div>
        </div>
        <Link to="air-conditioning" className="read-more p-2 rounded-5">Read more</Link>
      </div>
      <div className="cart-items w-100 d-flex flex-column text-center p-5 gap-3">
        <div className="cart-item align-items-center">
        ...
        <Link to="commercial-refrigeration" className="read-more p-2 rounded-5">Read more</Link>
      </div>
      <div className="cart-items w-100 d-flex flex-column text-center p-5 gap-3">
        <div className="cart-item align-items-center">
        <GiAutoRepair />
        <div className="text-start">
          ...
          <p className="p-0 m-0">Air-conditioning and Refrigeration Systems</p>
        </div>
        </div>
