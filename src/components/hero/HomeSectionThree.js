    ...
    <div className="HomeSectionThree gap-3">
      <div className="w-100 homeSectionThreeItem p-4">
        ...
        <p className="text-align-justify">
          ...
          <br />
          <br />
          As accredited installers all equipment supplied by is provided with an
          extended <span className="brand-color">7 YEAR </span>WARRANTY giving
          you peace of mind that your air conditioning unit remains reliable and
          energy efficient.
        </p>
      ...
      <div className="w-100 homeSectionThreeItem p-4">
        ...
        <p className="text-align-justify">
          ...
          Blast Chiller, Bottle Cooler, Cellar Cooler, Ice Maker / Machine, Sub
          Zero / Medical Refrigeration
          <span className="brand-color">24/7 repair service providing –</span>
          quick response time, top class service and quality of first time fix.
        </p>
        <Link to="contact-us" className=" read-more p-2 rounded-5 px-4">
          Request a Call Out
        </Link>
      ...
      <div className="w-100 homeSectionThreeItem p-4">
        ...
        <p className="text-align-justify">
          Our aim is to provide enhanced working environments so that businesses
          can operate at their best – without the pains of slow and expensive
          repairs.
        </p>
